...
* from Persona.idl
* lunes 7 de mayo de 2018 19H07' COT
*/
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       case 0:  // PersonaApp/Persona/insertarPersona
       {
         ...
         $result = this.insertarPersona (id_persona, nombre, apellido, telefono, direccion, correo);
         out = $rh.createReply();
       ...
       case 1:  // PersonaApp/Persona/consultarPersona
       {
         int id_persona = in.read_long ();
         String $result = null;
         $result = this.consultarPersona (id_persona);
         out = $rh.createReply();
       ...
       case 2:  // PersonaApp/Persona/eliminarPersona
       {
         int id_persona = in.read_long ();
         boolean $result = false;
         $result = this.eliminarPersona (id_persona);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }
       ...
       case 3:  // PersonaApp/Persona/actualizarPersona
       {
         ...
         String correo = in.read_wstring ();
         boolean $result = false;
         $result = this.actualizarPersona (id_persona, nombre, apellido, telefono, direccion, correo);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }
